...
Nesse desafio você irá construir o front-end com ReactJS do Meetapp que utilizará a API que você desenvolveu durante os desafios do segundo e terceiro módulo de Node.js (https://github.com/andersonbellini/bootcamp-gostack-desafio-09).
...
O layout do projeto está anexado no repositório.
